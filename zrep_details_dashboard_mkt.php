...
function cargaData($fecha){
	
	if($_GET['paquete']=='PAQUETE PREMIUM'){
		
		$query="select o.numerodeordeninterno,o.accountname,o.contactname, date_format(o.fechadeiniciodesuscripcion,'%Y %M'),date_format(o.fechadefindesuscripcion, '%Y %M'),o.tipo,p.productCode
			...
			where o.tipo like '%Renova%' and o.status!='Anulada' and p.productCode='SUSC-408' and date_format(o.fechadeiniciodesuscripcion,'%Y %M')='".$fecha."'";
	...
	elseif($_GET['paquete']=='Paquete Semana Económica'){
		...
		$query="select o.numerodeordeninterno,o.accountname,o.contactname,date_format(o.fechadeiniciodesuscripcion,'%Y %M'),date_format(o.fechadefindesuscripcion, '%Y %M'),o.tipo,p.productCode
				from zoho_salesorder o join zoho_salesdetail d on o.salesorderid=d.salesorderid join zoho_product p on p.productid=d.productid
				where o.tipo like '%Renova%' and o.status!='Anulada' and p.productCode='SUSC-404' and date_format(o.fechadeiniciodesuscripcion,'%Y %M')='".$fecha."'";
	...
	elseif($_GET['paquete']=='Analítica'){
		...
		$query="select o.numerodeordeninterno,o.accountname,o.contactname,date_format(o.fechadeiniciodesuscripcion,'%Y %M'),date_format(o.fechadefindesuscripcion, '%Y %M'),o.tipo,p.productCode
				from zoho_salesorder o join zoho_salesdetail d on o.salesorderid=d.salesorderid join zoho_product p on p.productid=d.productid
				where o.tipo like '%Renova%' and o.status!='Anulada' and p.productCode='SUSC-420' and date_format(o.fechadeiniciodesuscripcion,'%Y %M')='".$fecha."'";
	...
	elseif($_GET['paquete']=='Integral'){
		...
		$query="select o.numerodeordeninterno,o.accountname,o.contactname,date_format(o.fechadeiniciodesuscripcion,'%Y %M'),date_format(o.fechadefindesuscripcion, '%Y %M'),o.tipo,p.productCode
				from zoho_salesorder o join zoho_salesdetail d on o.salesorderid=d.salesorderid join zoho_product p on p.productid=d.productid
				where o.tipo like '%Renova%' and o.status!='Anulada' and (p.productCode ='SUSC-405' or p.productCode ='SUSC-411') and date_format(o.fechadeiniciodesuscripcion,'%Y %M')='".$fecha."'";
	...
	elseif($_GET['paquete']=='Online'){
		...
		$query="select o.numerodeordeninterno,o.accountname,o.contactname,date_format(o.fechadeiniciodesuscripcion,'%Y %M'),date_format(o.fechadefindesuscripcion, '%Y %M'),o.tipo,p.productCode
				from zoho_salesorder o join zoho_salesdetail d on o.salesorderid=d.salesorderid join zoho_product p on p.productid=d.productid
				where o.tipo like '%Renova%' and o.status!='Anulada' and p.productCode ='SUSC-403' and date_format(o.fechadeiniciodesuscripcion,'%Y %M')='".$fecha."'";
	...
	elseif($_GET['paquete']=='PAQUETE SE'){
		...
		$query="select o.numerodeordeninterno,o.accountname,o.contactname,date_format(o.fechadeiniciodesuscripcion,'%Y %M'),date_format(o.fechadefindesuscripcion, '%Y %M'),o.tipo,p.productCode
				from zoho_salesorder o join zoho_salesdetail d on o.salesorderid=d.salesorderid join zoho_product p on p.productid=d.productid
				where o.tipo like '%Renova%' and o.status!='Anulada' and p.productCode ='SUSC-407' and date_format(o.fechadeiniciodesuscripcion,'%Y %M')='".$fecha."'";
...
$query="select o.numerodeordeninterno,o.accountname,o.contactname,date_format(o.fechadeiniciodesuscripcion,'%Y %M'),date_format(o.fechadefindesuscripcion, '%Y %M'),o.tipo,p.productCode
		from zoho_salesorder o join zoho_salesdetail d on o.salesorderid=d.salesorderid join zoho_product p on p.productid=d.productid 
		where o.tipo like '%Renova%' and o.status!='Anulada' and (p.productCode ='SUSC-300' or p.productCode ='SUSC-301') 
		and date_format(o.fechadeiniciodesuscripcion,'%Y %M')='".$fecha."'";
 ...
 $query="select o.numerodeordeninterno,o.accountname,o.contactname,date_format(o.fechadeiniciodesuscripcion,'%Y %M'),
		date_format(o.fechadefindesuscripcion, '%Y %M'),o.tipo,p.productCode
		...
		date_format(o.fechadeiniciodesuscripcion,'%Y %M')='".$fecha."' and o.tipo like '%Renova%' and o.status!='Anulada' and (p.productCode ='SUSC-404'
		or p.productCode ='SUSC-400')";
		...
		echo "existe problemas al capturar el paquete:".$_GET['paquete']."";
	...
	while($row=mysql_fetch_array($result)){
			...
			echo"
             ...
             <td style=' ;ext-transform:capitalize; font-size:9px' id='body-table'>".$row[2]."</td>
